...
function BuyFree(gameType,betindex,datainfo,datainfos)
    ...
    --取图库2
    local alldisInfo = gameImagePool.RealCommonRotate(datainfos._id,GameId,gameType,2,sweetBonanza,{betchip=betMoney,gameId=GameId,gameType=gameType,betchips=chip})
...
function Normal(gameId,gameType, betindex, datainfo, datainfos, uid)
    ...
    --启用图库模式
    local alldisInfo,realMul,imageType = gameImagePool.RealCommonRotate(uid,GameId,gameType,nil,sweetBonanza,{betchip=betMoney,gameId=GameId,gameType=gameType,betchips=chip})
