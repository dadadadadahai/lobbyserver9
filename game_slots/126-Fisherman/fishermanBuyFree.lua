...
function BuyFree(gameType,betindex,datainfo,uid)
    ...
    --取图库2
    local alldisInfo,realMulall = gameImagePool.RealCommonRotate(uid,GameId,gameType,2,Fisherman,{betchip=betMoney,betIndex=betindex,gameId=GameId,gameType=gameType,betchips=betMoney})
...
function BuyFreeDemo(gameType,betindex,datainfo,uid)
    ...
    datainfo.betMoney = betMoney
    --取图库2
    local alldisInfo ,realMulall= gameImagePool.RealCommonRotate(uid,GameId,gameType,2,Fisherman,{betchip=betMoney,demo = IsDemo(uid),betIndex=betindex,gameId=GameId,gameType=gameType,betchips=betMoney})
