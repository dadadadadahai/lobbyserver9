...
function PlayNormalGame(elephantInfo,uid,betIndex,gameType)
    ...
    --     imageType = 2
    -- end
    local resultGame,realMul,imageType = gameImagePool.RealCommonRotate(uid,GameId,gameType,nil,Elephant,{betchip=payScore / LineNum,gameId=GameId,gameType=gameType,betchips=payScore})
