...
return {
    ...
    [1001] = {
        Formula = "https://webapi.xbet7k.com:8083/relation/bind/%s/%s",
        ID = 1001,
        desc = "好友邀请url",
    },

    [1002] = {
        Formula = "https://webapi.xbet7k.com:8083/sms/send/%s/%s",
        ID = 1002,
        desc = "短信验证url",
    },

    [1003] = {
        Formula = "https://webapi.xbet7k.com:8083/repay/repayState/%s/%s",
        ID = 1003,
        desc = "申请提现url",
    },

    [1004] = {
        Formula = "https://pay.xbet7k.com/collectdata/find/%s/%s",
        ID = 1004,
        desc = "查询gps_adid url",
    },
